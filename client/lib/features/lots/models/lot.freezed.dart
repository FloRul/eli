...
@JsonKey(name: "lot_id") String get lotId; String get title; String? get itp;@JsonKey(name: "final_acceptance_test") String? get finalAcceptanceTest;@JsonKey(name: "start_date") DateTime? get startDate; String? get incoterms;@JsonKey(name: "required_on_site_date") DateTime? get requiredOnSiteDate;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,lotId,title,itp,finalAcceptanceTest,startDate,incoterms,requiredOnSiteDate);

@override
String toString() {
  return 'Lot(lotId: $lotId, title: $title, itp: $itp, finalAcceptanceTest: $finalAcceptanceTest, startDate: $startDate, incoterms: $incoterms, requiredOnSiteDate: $requiredOnSiteDate)';
}
...
@useResult
$Res call({
@JsonKey(name: "lot_id") String lotId, String title, String? itp,@JsonKey(name: "final_acceptance_test") String? finalAcceptanceTest,@JsonKey(name: "start_date") DateTime? startDate, String? incoterms,@JsonKey(name: "required_on_site_date") DateTime? requiredOnSiteDate
});
...
/// Create a copy of Lot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lotId = null,Object? title = null,Object? itp = freezed,Object? finalAcceptanceTest = freezed,Object? startDate = freezed,Object? incoterms = freezed,Object? requiredOnSiteDate = freezed,}) {
...
class _Lot implements Lot {
  const _Lot({@JsonKey(name: "lot_id") required this.lotId, required this.title, this.itp, @JsonKey(name: "final_acceptance_test") this.finalAcceptanceTest, @JsonKey(name: "start_date") this.startDate, this.incoterms, @JsonKey(name: "required_on_site_date") this.requiredOnSiteDate});
...
/// Create a copy of Lot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lotId = null,Object? title = null,Object? itp = freezed,Object? finalAcceptanceTest = freezed,Object? startDate = freezed,Object? incoterms = freezed,Object? requiredOnSiteDate = freezed,}) {
  return _then(_Lot(
lotId: null == lotId ? _self.lotId : lotId // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,itp: freezed == itp ? _self.itp : itp // ignore: cast_nullable_to_non_nullable
